...
const DATA = {
    ...
    NPCS: [
        { id:'maire', name:'Marcel le Maire', commune:'athis', rx:2, ry:0, color:'#4A6FA5', hair:'#808080',
          ...
          dialogue: [
              'Bienvenue à Athis-Val-de-Rouvre, cher ami!',
        ...
        { id:'aubergiste', name:'Jeanne l\'Aubergiste', commune:'athis', rx:3, ry:-12, color:'#CC8855', hair:'#884422',
          personality: 'Accueillante et curieuse, tient une auberge sur le chemin du nord',
          dialogue: [
              'Ah, un voyageur ! Vous allez vers Ronfeugerai ?',
              'Mon auberge est un refuge pour tous les marcheurs de la région.',
              'Je tiens ce relais depuis que ma mère m\'a transmis la recette de la soupe normande.',
              'Si vous avez du bois à me donner, je vous prépare des provisions pour la route !',
          ],
          quips: [
              'Il y avait trois pèlerins ce matin. Ils allaient à Notre-Dame-du-Rocher.',
              'Mon potager est petit, mais la soupe que j\'en tire est grande !',
              'La route vers Ronfeugerai est belle en toutes saisons.',
              'Ce chemin que vous empruntez, ma famille l\'a entretenu pendant des générations.',
              'Un peu de cidre pour vous réchauffer ? Non ? Une autre fois !',
          ],
          seasonal: {
              printemps: 'Le printemps rend les voyageurs joyeux. Mon auberge est pleine !',
              ete: 'L\'été, les gens passent vite — ils courent voir la rivière. Je les comprends.',
              automne: 'L\'automne, je prépare de la confiture pour les voyageurs. Ça réchauffe.',
              hiver: 'En hiver les voyageurs ont besoin de chaleur. Ma porte est toujours ouverte.',
          },
          gives: { bois:3, pierre:2 },
          friendship_gift: { bois:5, miel:2 },
          quest: 'aubergiste',
          trade: { want:'bois', wantQty:3, give:'pierre', giveQty:2, give2:'miel', giveQty2:1,
                   msg:'Du bois bien sec ! Exactement ce qu\'il me faut pour le feu. Voici des provisions !' }
        },
    ...
    QUESTS: [
        ...
        { id:'aubergiste', name:'L\'Auberge du Chemin',
          desc:'Rencontrer Jeanne à l\'auberge, à mi-chemin vers Ronfeugerai.',
          type:'talk', target:'aubergiste',
          reward:{happiness:3, items:{bois:3, pierre:2}},
          rewardText:'Une halte bien méritée !' },
