...
const DATA = {
    ...
    BUILDINGS: {
        ...
        // ── Tier 3 : 3 bâtiments + avoir construit un jardin ou chaumière ─
        ...
        // ── Tier 4 : 5 bâtiments + avoir boulangerie ou moulin ───────────
    ...
    QUESTS: [
        ...
        { id:'fermiere2', name:'Le Défi de Josette',
          desc:'Josette vous défie : récoltez 4 types de légumes différents.',
          type:'harvest_types', target:4,
          locked:true,
          reward:{happiness:4, items:{graine_to:3}},
          rewardText:'Josette est impressionnée par votre potager !' },
        { id:'herboriste2', name:'La Tisane du Pêcheur',
          desc:'Madeleine vous demande d\'apporter du poisson à Robert pour sa tisane.',
          type:'collect_item', item:'poisson', qty:2,
          locked:true,
          reward:{happiness:3, items:{herbes:4, graine_f:2}},
          rewardText:'La tisane au poisson de Madeleine est légendaire !' },
        { id:'pecheur2', name:'Le Village de Robert',
          desc:'Robert vous conseille de construire au moins 5 structures pour le village.',
          type:'build_count', target:5,
          locked:true,
          reward:{happiness:4, items:{poisson:3}},
          rewardText:'Robert est fier du village qui grandit !' },
        ...
        { id:'meunier2', name:'L\'Ambition du Meunier',
          desc:'Augustin veut voir le village atteindre 25 points de bonheur.',
          type:'happiness', target:25,
          locked:true,
          reward:{happiness:3, items:{pierre:5}},
          rewardText:'Augustin crie votre gloire depuis son moulin !' },
        { id:'soeur2', name:'Le Jardin de la Chapelle',
          desc:'Sœur Thérèse rêve d\'un village fleuri : cultivez 4 légumes différents.',
          type:'harvest_types', target:4,
          locked:true,
          reward:{happiness:5, items:{pierre:4}},
          rewardText:'Sœur Thérèse prie pour votre potager chaque matin !' },
        { id:'apiculteur2', name:'Les Butineuses de Paul',
          desc:'Paul veut que vous observiez un papillon dans la nature.',
          type:'observe_species', target:'papillon',
          locked:true,
